  ...
  <body>
      ...
      <form name="cadforn" method="post" action="">
        <div class="form-group">
          <input type="text" name="txtnomeforn" pattern="^[a-zA-ZÁ-ù0-9 ]{2,50}$" placeholder="Nome do Fornecedor" class="form-control">
        </div>
        <div class="form-group">
          <input type="text" name="txtemailforn" pattern="^([0-9a-zA-Z]+([_.-]?[0-9a-zA-Z]+)*@[0-9a-zA-Z]+[0-9,a-z,A-Z,.,-]*(.){1}[a-zA-Z]{2,4})+$"
           placeholder="E-Mail do fornecedor" class="form-control">
        </div>
        <div class="form-group">
          <input type="text"  name="txttelforn" placeholder="Telefone do fornecedor" pattern="^\(?\d{2}\)?[\s-]?\d{4}-?\d{4}$"  class="form-control">
        </div>
        ...
        if(isset($_POST['cadastrar'])){
          ...
          $_SESSION['msg']="<span class='alert alert-info'>Fornecedor Cadastrado com sucesso!</span> <br>";
